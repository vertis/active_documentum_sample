class DmClientRights < DmSysobject
...
# client_id => {:name=>"client_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# public_key_identifier => {:name=>"public_key_identifier", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# allowed_roles => {:name=>"allowed_roles", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# allow_all_roles => {:name=>"allow_all_roles", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# allow_all_priv_modules => {:name=>"allow_all_priv_modules", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# principal_auth_priv => {:name=>"principal_auth_priv", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
