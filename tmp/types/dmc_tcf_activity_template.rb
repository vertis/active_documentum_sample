class DmcTcfActivityTemplate < DmDocument
...
# act_template_identifier => {:name=>"act_template_identifier", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>256, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# template_groups => {:name=>"template_groups", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
