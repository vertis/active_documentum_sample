...
# staging_location => {:name=>"staging_location", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# relative_path => {:name=>"relative_path", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>200, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
