class DmEmailMessage < DmDocument
...
# message_identifier => {:name=>"message_identifier", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# media_type => {:name=>"media_type", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# date_published => {:name=>"date_published", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# date_received => {:name=>"date_received", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# recipients => {:name=>"recipients", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>48, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# other_recipients => {:name=>"other_recipients", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>48, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# originating_org => {:name=>"originating_org", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
