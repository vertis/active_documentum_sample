class DmcTcfActivity < DmDocument
...
# act_identifier => {:name=>"act_identifier", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>256, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
