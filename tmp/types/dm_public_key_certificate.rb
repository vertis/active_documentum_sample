class DmPublicKeyCertificate < DmSysobject
...
# key_identifier => {:name=>"key_identifier", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# key_type => {:name=>"key_type", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# private_key_identifier => {:name=>"private_key_identifier", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# certificate_value => {:name=>"certificate_value", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1900, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
