class DmcCompositePredicate < ActiveDocumentum::Base
# predicate_id => {:name=>"predicate_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
