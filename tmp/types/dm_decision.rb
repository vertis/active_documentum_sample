...
# router_id => {:name=>"router_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# compare_attribute => {:name=>"compare_attribute", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# compare_operator => {:name=>"compare_operator", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# compare_value => {:name=>"compare_value", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# true_tasks => {:name=>"true_tasks", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>3, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# false_tasks => {:name=>"false_tasks", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>3, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
