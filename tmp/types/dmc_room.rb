...
# builtin_groups => {:name=>"builtin_groups", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# is_public => {:name=>"is_public", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>["0"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# only_owners_ungovern => {:name=>"only_owners_ungovern", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>["0"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# default_owner_permit => {:name=>"default_owner_permit", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>["0"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# default_owner_xpermit => {:name=>"default_owner_xpermit", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# default_contrib_permit => {:name=>"default_contrib_permit", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>["0"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# default_contrib_xpermit => {:name=>"default_contrib_xpermit", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# status_value => {:name=>"status_value", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>["0"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# status_text => {:name=>"status_text", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>2000, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
