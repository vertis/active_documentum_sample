class DmcWfsdTypeInfo < DmSysobject
...
# sdt_name => {:name=>"sdt_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# element_type_name => {:name=>"element_type_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>27, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# report_type_name => {:name=>"report_type_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>27, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# type_description => {:name=>"type_description", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1024, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# xml_schema_id => {:name=>"xml_schema_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# xml_config_id => {:name=>"xml_config_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# attr_display_name => {:name=>"attr_display_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_sdt_name => {:name=>"attr_sdt_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>2000, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_element_type_name => {:name=>"attr_element_type_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_description => {:name=>"attr_description", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_type => {:name=>"attr_type", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_is_repeating => {:name=>"attr_is_repeating", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_is_reportable => {:name=>"attr_is_reportable", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_is_searchable => {:name=>"attr_is_searchable", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_is_filterable => {:name=>"attr_is_filterable", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# attr_default_value => {:name=>"attr_default_value", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
