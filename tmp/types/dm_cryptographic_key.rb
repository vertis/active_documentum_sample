class DmCryptographicKey < DmSysobject
...
# key_value => {:name=>"key_value", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1000, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
