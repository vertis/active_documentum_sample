...
# selected_sources => {:name=>"selected_sources", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>256, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# has_results => {:name=>"has_results", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# results_count => {:name=>"results_count", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
