...
# project_version_major => {:name=>"project_version_major", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>["1"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# project_version_minor => {:name=>"project_version_minor", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>["0"], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# manifest_version => {:name=>"manifest_version", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
