class DmcWfPackageTypeInfo < DmSysobject
...
# package_type_name => {:name=>"package_type_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>27, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# reportable_attribute => {:name=>"reportable_attribute", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>40, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
