class DmcRelationshipDef < DmSysobject
...
# rel_description => {:name=>"rel_description", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1024, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# source_role => {:name=>"source_role", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# target_role => {:name=>"target_role", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# source_type => {:name=>"source_type", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>27, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# target_type => {:name=>"target_type", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>27, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# rel_degree => {:name=>"rel_degree", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# is_composition => {:name=>"is_composition", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# required_source_aspects => {:name=>"required_source_aspects", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>64, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# required_target_aspects => {:name=>"required_target_aspects", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>64, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# operation_name => {:name=>"operation_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# operation_module => {:name=>"operation_module", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# operation_module_metadata => {:name=>"operation_module_metadata", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1024, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# source_constraint_set_id => {:name=>"source_constraint_set_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# target_constraint_set_id => {:name=>"target_constraint_set_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
