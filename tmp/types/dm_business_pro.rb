class DmBusinessPro < DmSysobject
...
# process_name => {:name=>"process_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# status_labels => {:name=>"status_labels", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# time_out_methods => {:name=>"time_out_methods", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>9, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
