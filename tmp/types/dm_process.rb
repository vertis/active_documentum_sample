...
# perf_alias_set_id => {:name=>"perf_alias_set_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# package_control => {:name=>"package_control", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# sd_element_default_acl => {:name=>"sd_element_default_acl", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# calendar_id => {:name=>"calendar_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# execution_flag => {:name=>"execution_flag", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# current_environment => {:name=>"current_environment", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>64, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# r_act_priority => {:name=>"r_act_priority", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_act_type => {:name=>"r_act_type", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
...
# r_link_name => {:name=>"r_link_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_link_src_act => {:name=>"r_link_src_act", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_link_src_port => {:name=>"r_link_src_port", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_link_dest_act => {:name=>"r_link_dest_act", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_link_dest_port => {:name=>"r_link_dest_port", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_choose_name => {:name=>"act_choose_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_choose_by => {:name=>"act_choose_by", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_choose_for => {:name=>"act_choose_for", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
...
# sd_element_type => {:name=>"sd_element_type", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# sd_element_options => {:name=>"sd_element_options", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# sd_element_default_value => {:name=>"sd_element_default_value", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>2000, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# sd_element_acl => {:name=>"sd_element_acl", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# sd_element_parent_id => {:name=>"sd_element_parent_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_performer_rule => {:name=>"act_performer_rule", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_performer_from => {:name=>"act_performer_from", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_performer_to => {:name=>"act_performer_to", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# parameter_name => {:name=>"parameter_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# parameter_id => {:name=>"parameter_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# deploy_environment => {:name=>"deploy_environment", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>64, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_group_name => {:name=>"act_group_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# act_group_id => {:name=>"act_group_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# target_namespace_uri => {:name=>"target_namespace_uri", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>2000, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
