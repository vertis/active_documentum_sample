class DmEsignTemplate < DmDocument
...
# document_type => {:name=>"document_type", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# max_signatures => {:name=>"max_signatures", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# begin_tag => {:name=>"begin_tag", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# end_tag => {:name=>"end_tag", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# append_to_body => {:name=>"append_to_body", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
