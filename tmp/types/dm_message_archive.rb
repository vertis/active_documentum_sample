class DmMessageArchive < DmMessageContainer
...
# is_archive_message => {:name=>"is_archive_message", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_class => {:name=>"message_class", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_doctype => {:name=>"message_doctype", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# datamodel_version => {:name=>"datamodel_version", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>6, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# i_sharing_type => {:name=>"i_sharing_type", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# i_orig_parent => {:name=>"i_orig_parent", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# allow_propagating_changes => {:name=>"allow_propagating_changes", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# retention_start_date => {:name=>"retention_start_date", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_id => {:name=>"message_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>42, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_subject => {:name=>"message_subject", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>256, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_size => {:name=>"message_size", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_link_count => {:name=>"message_link_count", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# sent_date => {:name=>"sent_date", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# receive_date => {:name=>"receive_date", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_sensitivity => {:name=>"message_sensitivity", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_importance => {:name=>"message_importance", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# attachment_count => {:name=>"attachment_count", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# parent_message_id => {:name=>"parent_message_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>24, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# tracking_id => {:name=>"tracking_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>2000, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# conversation_id => {:name=>"conversation_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_id_timestamp => {:name=>"message_id_timestamp", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>8, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# is_encrypted => {:name=>"is_encrypted", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# i_sharing_parent => {:name=>"i_sharing_parent", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
