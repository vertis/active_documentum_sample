...
# com_class_id => {:name=>"com_class_id", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>38, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# component_version => {:name=>"component_version", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>16, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# build_technology => {:name=>"build_technology", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# uniq_cont_ticket => {:name=>"uniq_cont_ticket", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>128, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
