class DmcConstraintSet < DmSysobject
...
# constraint_name => {:name=>"constraint_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# module_name => {:name=>"module_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>255, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# constraint_metadata => {:name=>"constraint_metadata", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1024, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
