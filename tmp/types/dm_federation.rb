class DmFederation < DmSysobject
...
# r_govern_docbase => {:name=>"r_govern_docbase", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>120, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# r_govern_is_active => {:name=>"r_govern_is_active", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# r_govern_suspended => {:name=>"r_govern_suspended", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# r_member_docbases => {:name=>"r_member_docbases", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>120, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_member_is_active => {:name=>"r_member_is_active", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_member_refresh => {:name=>"r_member_refresh", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# user_subtypes => {:name=>"user_subtypes", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
