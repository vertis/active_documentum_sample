class DmNetworkLocationMap < DmSysobject
...
# netloc_ident => {:name=>"netloc_ident", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# netloc_display_name => {:name=>"netloc_display_name", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# default_netloc => {:name=>"default_netloc", :description=>"", :data_type=>"BOOLEAN", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# begin_near_ip_address => {:name=>"begin_near_ip_address", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# end_near_ip_address => {:name=>"end_near_ip_address", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# ip_address_range => {:name=>"ip_address_range", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>240, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
