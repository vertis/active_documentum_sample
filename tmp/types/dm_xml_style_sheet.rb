class DmXmlStyleSheet < DmDocument
...
# transformed_format => {:name=>"transformed_format", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>80, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
