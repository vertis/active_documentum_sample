class DmMessageUserData < ActiveDocumentum::Base
# message_object_id => {:name=>"message_object_id", :description=>"", :data_type=>"OBJECT_ID", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# user_tag => {:name=>"user_tag", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>64, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# user_data => {:name=>"user_data", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>2000, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
