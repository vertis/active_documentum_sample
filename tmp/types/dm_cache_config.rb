class DmCacheConfig < DmSysobject
...
# server_check_interval => {:name=>"server_check_interval", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# client_check_interval => {:name=>"client_check_interval", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# cache_element_type => {:name=>"cache_element_type", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>32, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# cache_element_query => {:name=>"cache_element_query", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>1500, :default_values=>[], :is_array=>true, :is_dynamic=>false, :is_required=>false}
# r_last_checked_date => {:name=>"r_last_checked_date", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# r_last_changed_date => {:name=>"r_last_changed_date", :description=>"", :data_type=>"DATE", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# i_query_result_hash => {:name=>"i_query_result_hash", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>100, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
