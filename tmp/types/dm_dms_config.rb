...
# message_post_url => {:name=>"message_post_url", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>240, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
# message_consume_url => {:name=>"message_consume_url", :description=>"", :data_type=>"STRING", :dependencies=>[], :length=>240, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
...
# dms_capability => {:name=>"dms_capability", :description=>"", :data_type=>"INTEGER", :dependencies=>[], :length=>0, :default_values=>[], :is_array=>false, :is_dynamic=>false, :is_required=>false}
